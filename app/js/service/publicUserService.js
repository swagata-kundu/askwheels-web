...
app.service('publicUserService', ['$http', 'serviceURI', 'localStorageService', '$q', '$rootScope', 'siteInfo', function ($http, serviceURI, localStorageService, $q, $rootScope, siteInfo) {
